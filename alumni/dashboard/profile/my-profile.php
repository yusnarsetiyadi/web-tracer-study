        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <img src="../../admin/dashboard/alumni/foto/<?= $data['foto_alumni'] ?>" alt="Profile"
                        class="rounded-circle">
                    <h2><?= ucfirst($data['nama_lengkap']) ?></h2>
                    <h3><?= ucfirst($data['jurusan']) ?></h3>
                    ...
                    <div class="tab-content pt-2">
                        ...
                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8"><?= ucfirst($data['nama_lengkap']) ?></div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Jurusan</div>
                                <div class="col-lg-9 col-md-8"><?= ucfirst($data['jurusan']) ?></div>
                            </div>

                            <div class="row">
                                <div class="col-lg-3 col-md-4 label">Tahun Lulus</div>
                                <div class="col-lg-9 col-md-8"><?= ucfirst($data['tahun_lulus']) ?></div>
                            </div>
