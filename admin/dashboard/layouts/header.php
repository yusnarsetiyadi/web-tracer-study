    ...
    <ul class="d-flex align-items-center">
      <li class="nav-item dropdown pe-3">
        ...
        <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
          <?php
          if ($_SESSION['foto_profil'] == null) {
            echo '

                        <img src="../../assets/img/users/default.png" alt="Foto-Profile" class="rounded-circle">
            ...
            echo '
                      ...
                      <img src="../../assets/img/users/' . $data['foto_profil'] . '" alt="Foto-Profile" class="rounded-circle">
                      <span class="ms-1 d-none d-md-inline-block">
                          ' . ucfirst($_SESSION['username']) . '<i class="mdi mdi-chevron-down"></i>
                      </span>';
          }
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          <li class="dropdown-header">
            ...
            <span><?php echo ucfirst($_SESSION['jabatan']); ?></span>
          </li>
          <li>
