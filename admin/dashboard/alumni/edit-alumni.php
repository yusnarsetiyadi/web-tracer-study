        ...
        <form class="row g-3" method="post" action="alumni/proses/proses-edit-alumni.php?id=<?= $id ?>">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                    value="<?php echo $data['nama_lengkap'] ?>" maxlength="50" pattern="^[A-Za-z ]+$" required>
            </div>
            <div class="col-md-6">
                <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                    value="<?php echo $data['tempat_lahir'] ?>" maxlength="50" pattern="^[A-Za-z ]+$" required>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="jurusan" name="jurusan"
                    value="<?php echo $data['jurusan'] ?>" maxlength="50" maxlength="50" required>
            </div>

            <div class="col-md-6">
                <label for="tahun_lulus" class="form-label">Tahun Lulus</label>
                <input type="text" class="form-control" id="tahun_lulus" name="tahun_lulus"
                    value="<?php echo $data['tahun_lulus'] ?>" maxlength="50" maxlength="4" pattern="^\d{4}$" required>
            </div>
